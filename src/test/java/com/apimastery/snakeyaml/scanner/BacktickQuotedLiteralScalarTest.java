...
public class BacktickQuotedLiteralScalarTest {
    ...
    public void test_EndsWithNewLine_FollowedByFieldAtOuterLevel() throws Exception {
        // @formatter:off
        String yamlSimlet = "" + "response:\n" + "  from: stub\n" + "  body: `\n" + "{\n"
                + "  \"status\": \"OK\"\n" + "}\n" +
                // ends on new line
                "`\n" +
                // ...and followed by a field at the parent's (outer)
                // indentation level
                "rank: 1" + "";
        // @formatter:on
    ...
    public void test_FirstCharIsRightAfterTheQuotes() {
        ...
        try {
            ...
            final Iterator<Object> docsIterator = docs.iterator();
            while (docsIterator.hasNext()) {
                // This call should throw the exception we catch and process
                // below
                docsIterator.next();
    ...
    public void test_EndOfStreamAfterOpeningQuotes() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("scanning for end of line"));
            Assert.assertTrue(
                    e.getMessage().contains("expected end of line but got end of stream"));
        }
    }
    ...
    @Test
    public void test_ContainsEscapedBacktickCharacter() throws Exception {
        // @formatter:off
        String yamlSimlet = "" +
            "response:\n" +
            "  from: stub\n" +
